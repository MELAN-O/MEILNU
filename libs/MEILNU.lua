...
os.execute('rm -rf MEILNU.lua') 
os.execute('wget https://raw.githubusercontent.com/MELAN-O/MEILNU/master/MEILNU.lua') 
dofile('MEILNU.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/MELAN-O/MEILNUFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/MELAN-O/MEILNUFiles/master/MEILNUFiles/"..FileName)
if Res == 200 then
